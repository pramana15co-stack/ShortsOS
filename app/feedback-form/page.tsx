        ...
        <div className="bg-white rounded-xl shadow-md p-12 text-center">
          <div className="mb-6">
            ...
            <p className="text-xl text-gray-600 mb-6">
              Your feedback has been received. The Pramana15 team reads every submission and uses it to make ShortsOS better.
            </p>
            <div className="bg-primary-50 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
              <p className="text-gray-700 leading-relaxed">
                The Pramana15 team is constantly improving based on feedback from creators like you. 
