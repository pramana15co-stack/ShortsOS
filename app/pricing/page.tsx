            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">AI Video Prompt Studio</div>
                    <div className="text-sm text-gray-600">5 credits per generation</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Hook & Caption Engine</div>
                    <div className="text-sm text-gray-600">3 credits per generation</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
